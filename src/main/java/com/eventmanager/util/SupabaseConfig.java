    ...
    static {
        try {
            ...
            if (supabaseUrl == null || supabaseUrl.isEmpty()) {
                ...
                logger.warn("SUPABASE_URL no encontrado en variables de entorno, usando valor por defecto");
            }
            ...
            logger.info("Configuración de Supabase inicializada correctamente");
        } catch (Exception e) {
